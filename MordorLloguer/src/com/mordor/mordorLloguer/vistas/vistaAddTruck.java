...
public class vistaAddTruck extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public vistaAddTruck() {
		setFrameIcon(new ImageIcon(vistaAddTruck.class.getResource("/com/mordor/mordorLloguer/assets/car.png")));
		setClosable(true);
