...
public class JIFInvoice extends JInternalFrame {
	...
	/*** Create the frame. */
	public JIFInvoice() {
		setFrameIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/invoice.png")));
		setTitle("Facturas");
		setMaximizable(true);
		setClosable(true);
		...
		btnNewInvoce.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/invoiceAdd.png")));
		toolBar.add(btnNewInvoce);
		btnRemoveInvoice = new JButton("");
		btnRemoveInvoice.setToolTipText("Eliminar factura");
		btnRemoveInvoice
				.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/invoiceRemove.png")));
		toolBar.add(btnRemoveInvoice);
		toolBar.addSeparator(new Dimension(20, 10));
		btnCheck = new JButton("");
		btnCheck.setToolTipText("Confirm vehicle");
		btnCheck.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/check.png")));
		toolBar.add(btnCheck);
		toolBar.addSeparator(new Dimension(20, 10));
		btnAddDetail = new JButton("");
		btnAddDetail.setToolTipText("Añadir detalle");
		btnAddDetail.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/Add.png")));
		toolBar.add(btnAddDetail);
		btnRemoveDetail = new JButton("");
		btnRemoveDetail.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/Remove.png")));
		...
		btnPrint.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/Printer.png")));
		toolBar.add(btnPrint);
		btnPdf = new JButton("");
		btnPdf.setToolTipText("Exportar a pdf");
		btnPdf.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/pdf.png")));
		toolBar.add(btnPdf);
		...
		btnPreviousInvoice
				.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/leftArrow.png")));
		btnNextInvoice = new JButton("");
		panel_2.add(btnNextInvoice);
		btnNextInvoice.setToolTipText("Siguiente factura");
		btnNextInvoice
				.setIcon(new ImageIcon(JIFInvoice.class.getResource("/com/mordor/mordorLloguer/assets/rightArrow.png")));
