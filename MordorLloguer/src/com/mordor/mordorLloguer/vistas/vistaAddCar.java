...
public class vistaAddCar extends JInternalFrame {
	...
	private JTextField txtFieldMotor;
	...
	public vistaAddCar() {
		...
		txtFieldMotor = new JTextField();
		getContentPane().add(txtFieldMotor, "cell 1 10,growx");
		txtFieldMotor.setColumns(10);
	...
	public JTextField getTxtFieldMotor() {
		return txtFieldMotor;
	}
