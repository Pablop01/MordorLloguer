...
public class vistaEditBus extends JInternalFrame {
	 ...
	 */
	public vistaEditBus() {
		setFrameIcon(new ImageIcon(vistaEditBus.class.getResource("/com/mordor/mordorLloguer/assets/car.png")));
		setClosable(true);
		...
		JLabel lblNumpuertas = new JLabel("Medida:*");
